...
> [!NOTE]
> **Dynamic Engine Loading & Capability Probing**
> Under the hood, Bloc loads engines dynamically via a Plugin Registry architecture. Instead of hardcoding flag names, Bloc performs **Capability Probing** on the engine binary at startup to ensure it uses the correct flag syntax for the specific version installed on your system.
